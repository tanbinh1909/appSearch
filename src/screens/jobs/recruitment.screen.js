...
export class RecruitmentScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            listRecruitment: [
    ...
    renderItemRecruitment = ({item}) => {
        ...
        return (
            <TouchableOpacity style={styles.containerItem} onPress={()=> this.props.navigation.navigate("RecruitmentPostDetailScreen", {postRecruitment: item})}>
        ...
        return (
            <View style={styles.container}>
                <View style ={styles.viewBody}>
                    <View style={{}}>
                        <TouchableOpacity style={styles.buttonSearch} onPress={() => this.props.navigation.navigate("AddPostRecruitmentScreen")}>
                            <Text style={styles.textSearch}>Tạo bài đăng</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{flex:1}} >
                        {!loading ? (
