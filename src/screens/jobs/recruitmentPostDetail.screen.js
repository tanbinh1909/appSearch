...
export class RecruitmentPostDetailScreen extends Component {
            ...
            <View style={styles.container}>
                <View style={styles.containerView}>
                    ...
                    <View style={styles.buttomContainer}>
                        <TouchableOpacity style={styles.buttomTextUpdate} onPress={() => this.props.navigation.navigate("UpdatePostRecruitmentScreen", {postRecruitment})}>
...
export default connect(mapStateToProps, mapDispatchToProps) (RecruitmentPostDetailScreen);
