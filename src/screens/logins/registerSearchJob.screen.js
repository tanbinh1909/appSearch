...
import {saveRegisterJob} from "../../helpers/storage.helper";
import {connect} from 'react-redux';
import CustomerApi from '../../apis/customer.api';

export class RegisterSearchJobScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: "",
  ...
  validateRegister(){
    var check = true;
    const {username, email, password, againPassword} = this.state;
    if(username == "") {
  ...
  login = () => {
    ...
    render() {
       const {username, email, password, againPassword, isLoading} = this.state;
...
export default connect(null, null) (RegisterSearchJobScreen);
